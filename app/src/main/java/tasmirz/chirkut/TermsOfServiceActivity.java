...
public class TermsOfServiceActivity extends AppCompatActivity implements JsonFetcher.JsonFetcherCallback {
    ...
    public void onJsonFetched(String json) {
        List<JsonParser.ContentItem> contentItems = JsonParser.parseJson(json, "toc");
